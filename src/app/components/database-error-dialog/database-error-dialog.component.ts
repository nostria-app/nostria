...
@Component({
  ...
  imports: [MaterialCustomDialogComponent, MatButtonModule, MatIconModule, MatProgressSpinnerModule],
  template: `
    ...
    >
      ...
      <div dialog-actions>
        @if (operationStatus() === 'delete-success') {
          <button mat-flat-button type="button" class="primary" (click)="reloadPage()">
            Reload Page
          </button>
        } @else {
          @if (!isProcessing()) {
