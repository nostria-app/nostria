import { Component, inject, signal, computed, ElementRef, ViewChild, ViewChildren, QueryList, AfterViewInit, OnDestroy, ChangeDetectionStrategy } from '@angular/core';
...
export class CommandPaletteDialogComponent implements AfterViewInit, OnDestroy {
  ...
  commands: Command[] = [
    ...
    },
    {
      ...
      keywords: ['servers', 'groups', 'nip29', 'nip-29', 'discord', 'communities', 'voice']
    },
    {
    ...
    },
    {
      ...
      icon: 'travel_explore',
      action: () => this.router.navigate(['/collections/web']),
