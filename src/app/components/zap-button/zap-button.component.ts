...
@Component({
  ...
  imports: [CommonModule, MatButtonModule, MatIconModule, MatTooltipModule, CelebrationBurstComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <app-celebration-burst class="zap-button-container"
         theme="zap"
         mode="button"
      ...
      @if (quickZapEnabled()) {
        ...
        <button
          mat-icon-button
          class="zap-button celebration-target"
