...
describe('NotificationsComponent', () => {
    ...
    describe('mark all as read button', () => {
        it('should show mark all as read button in the header when notifications exist', async () => {
            ...
            const markAllButton = headerButtons.find(btn => btn.querySelector('mat-icon')?.textContent?.trim() === 'done_all');
        ...
        it('should not have mark all as read inside the overflow menu', async () => {
            ...
            const markAllMenuItem = Array.from(menuItems).find((item: Element) => item.querySelector('mat-icon')?.textContent?.trim() === 'done_all');
