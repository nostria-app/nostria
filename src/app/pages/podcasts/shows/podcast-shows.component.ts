...
@Component({
  ...
  template: `
    <div class="panel-header">
      ...
      <h2 class="panel-title title-font" i18n="@@podcasts.shows.title">Shows</h2>
    ...
    <div class="page">
      ...
      @if (loading() && filtered().length === 0) {
        ...
        <div class="empty">
          ...
          <p i18n="@@podcasts.shows.empty">No shows match this filter.</p>
        </div>
      } @else {
        <div class="shows-grid">
          @for (show of filtered(); track show.id) {
...
export class PodcastShowsComponent implements OnDestroy {
