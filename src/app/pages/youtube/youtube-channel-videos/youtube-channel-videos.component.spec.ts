...
function createComponent(): YouTubeChannelVideosComponent {
    ...
    (component as any).route = {
        snapshot: {
            paramMap: {
                get: vi.fn().mockReturnValue('UC123'),
            },
        },
    };
...
describe('YouTubeChannelVideosComponent', () => {
    describe('formatViews', () => {
        it('should format millions', () => {
            ...
            expect(component.formatViews(1234567)).toBe('1.2M');
        });

        it('should format thousands', () => {
            const component = createComponent();
            expect(component.formatViews(45600)).toBe('45.6K');
        });
        ...
        it('should format exactly 1 million as M', () => {
            const component = createComponent();
            expect(component.formatViews(1000000)).toBe('1.0M');
        });
    });
    ...
    describe('addToQueue', () => {
        it('should create a media item and call mediaPlayer.enque', () => {
            ...
            expect((component as any).snackBar.open).toHaveBeenCalledWith('Added to queue', 'Close', { duration: 2000 });
        });
    });
    ...
    describe('refresh', () => {
        it('should call fetchVideos when feedUrl is set', async () => {
            ...
            expect((component as any).corsProxy.fetchText).toHaveBeenCalledWith('https://www.youtube.com/feeds/videos.xml?channel_id=UC123');
        });
