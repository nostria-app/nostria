...
describe('AddYouTubeChannelDialogComponent', () => {
    ...
    describe('resolveChannelInput', () => {
        it('should handle a full feed URL', async () => {
            const component = createComponent();
            (component as any).corsProxy.fetchText.mockResolvedValue(sampleChannelHtml);

            const result = await component.resolveChannelInput('https://www.youtube.com/feeds/videos.xml?channel_id=UC1XvxnHFtWruS9egyFasP1Q');
        ...
        it('should handle a channel page URL', async () => {
            ...
            const result = await component.resolveChannelInput('https://www.youtube.com/channel/UC1XvxnHFtWruS9egyFasP1Q');
        ...
        it('should return null and set error when handle URL cannot be resolved', async () => {
            const component = createComponent();
            (component as any).corsProxy.fetchText.mockResolvedValue('<html><body>Not found</body></html>');
        ...
        it('should return null when handle URL fetch throws', async () => {
            const component = createComponent();
            (component as any).corsProxy.fetchText.mockRejectedValue(new Error('Network error'));
    ...
    describe('resolveHandleUrl', () => {
        ...
        it('should return null when channel ID cannot be extracted', async () => {
            const component = createComponent();
            (component as any).corsProxy.fetchText.mockResolvedValue('<html><body>No metadata</body></html>');
        ...
        it('should return null on fetch error', async () => {
            const component = createComponent();
            (component as any).corsProxy.fetchText.mockRejectedValue(new Error('Failed'));
    ...
    describe('fetchChannelThumbnail', () => {
        it('should fetch the channel page and extract thumbnail', async () => {
            ...
            expect((component as any).corsProxy.fetchText).toHaveBeenCalledWith('https://www.youtube.com/channel/UCxxxxNASAchannelIDxxxx');
        });
    ...
    describe('fetchAndValidate', () => {
        it('should resolve handle URL and populate channel info', async () => {
            ...
            (component as any).corsProxy.fetchText.mockImplementation((url: string) => {
    ...
    describe('save', () => {
        ...
        it('should use channelTitle as fallback when title is empty', () => {
            ...
            expect((component as any).dialogRef.close).toHaveBeenCalledWith(expect.objectContaining({ title: 'NASA' }));
        });
