import { supportsFullscreenApi, supportsWebkitVideoFullscreen, isInFullscreen, requestFullscreen, exitFullscreen, toggleFullscreen, addFullscreenChangeListener, } from './fullscreen';
...
describe('Fullscreen Utilities', () => {
    ...
    describe('requestFullscreen', () => {
        it('should use standard API when available on container', async () => {
            ...
            container.requestFullscreen = vi.fn().mockReturnValue(Promise.resolve());
        ...
        it('should fall back to webkit when standard API fails', async () => {
            const container = document.createElement('div');
            container.requestFullscreen = vi.fn().mockReturnValue(Promise.reject(new Error('Not supported')));
    ...
    describe('exitFullscreen', () => {
        it('should use standard API when fullscreenElement exists', async () => {
            ...
            document.exitFullscreen = vi.fn().mockReturnValue(Promise.resolve());
