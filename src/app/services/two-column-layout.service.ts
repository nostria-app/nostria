...
export class TwoColumnLayoutService {
  ...
  private handleRouteChange(url: string): void {
    ...
    // - Home, music, podcasts, streams, messages, bookmarks, articles, discover, people, calendar, and AI get wide mode (1400px)
    // - Other routes get narrow mode (700px) by default
    // Components can override this by calling setWideLeft() in their lifecycle
    const wideRoutes = ['streams', 'clips', 'music', 'podcasts', 'messages', 'chats', 'g', 'c', 'collections/bookmarks', 'collections/web', 'collections/media', 'articles', 'discover', 'people', 'calendar', 'ai'];
