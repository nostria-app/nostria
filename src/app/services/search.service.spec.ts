...
function createProfile(
  ...
  if (opts.nip05 !== undefined) data['nip05'] = opts.nip05;
  if (opts.about !== undefined) data['about'] = opts.about;
      ...
      providers: [
        ...
        { provide: PLATFORM_ID, useValue: 'browser' },
        {
          ...
          useValue: {
            ...
            openProfileAsPrimary: jasmine.createSpy('openProfileAsPrimary'),
        ...
        },
        {
          ...
          useValue: { getEventById: jasmine.createSpy('getEventById') },
        },
        {
          provide: RelaysService,
          useValue: { getAllObservedRelays: jasmine.createSpy('getAllObservedRelays').and.returnValue(Promise.resolve([])) },
        },
        {
        ...
        },
        {
          ...
          useValue: {
            searchCachedProfiles: jasmine.createSpy('searchCachedProfiles').and.returnValue(Promise.resolve([])),
            saveEvent: jasmine.createSpy('saveEvent'),
          },
        },
        { provide: MatDialog, useValue: { open: jasmine.createSpy('open') } },
        {
          provide: EventService,
          useValue: { createNote: jasmine.createSpy('createNote') },
        },
        {
          provide: MediaPlayerService,
          useValue: { media: signal([]), enque: jasmine.createSpy('enque') },
        },
        {
          provide: RssParserService,
          useValue: { parse: jasmine.createSpy('parse') },
        },
        {
          provide: SearchRelayService,
          useValue: {
            searchProfiles: jasmine.createSpy('searchProfiles').and.returnValue(Promise.resolve([])),
