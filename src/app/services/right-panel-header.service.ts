 ...
 * 
 * Components rendered in the right panel can use this service to provide
 * their header content (title, buttons, menus) which will be rendered
 * at the app level - directly inside .right-panel before .panel-content-wrapper.
 * 
...
export class RightPanelHeaderService {
  ...
  /**
   * Set the header template for the right panel.
