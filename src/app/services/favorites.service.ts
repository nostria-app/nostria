...
export class FavoritesService {
  ...
  addFavorite(userPubkey: string): boolean {
    ...
    this.logger.debug('Added user to favorites', { userPubkey, account: currentPubkey });
    return true;
  }
  ...
  removeFavorite(userPubkey: string): boolean {
    ...
    this.logger.debug('Removed user from favorites', { userPubkey, account: currentPubkey });
    return true;
  }
  ...
  clearCurrentAccountFavorites(): void {
    ...
    this.logger.info('Cleared all favorites for current account', { account: currentPubkey });
  }
