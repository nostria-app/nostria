...
export class SettingsRegistryService {
  ...
  readonly items: SettingsItem[] = [
    ...
    },
    {
      ...
      icon: 'dns',
      route: '/settings/max-relays-per-user',
      authenticated: true,
      priority: 10,
    },
    {
    ...
    },
    {
      ...
      sectionTitle: $localize`:@@settings.sections.network:Relays & Network`,
      icon: 'key',
      route: '/settings/auto-relay-auth',
      authenticated: true,
      priority: 11,
    },
    {
    ...
    },
    {
      ...
      sectionTitle: $localize`:@@settings.sections.content:Feed & Content`,
      icon: 'blur_on',
      route: '/settings/placeholder-algorithm',
      priority: 13,
    },
    {
      id: 'auto-play-video',
      ...
      sectionTitle: $localize`:@@settings.sections.content:Feed & Content`,
      icon: 'play_circle',
      route: '/settings/auto-play-video',
      priority: 14,
    },
    {
      ...
      icon: 'navigation',
      route: '/settings/navigation-settings',
      priority: 1,
    },
    {
      id: 'home-destination',
      ...
      sectionTitle: $localize`:@@settings.sections.navigation:Menu & Navigation`,
      icon: 'home',
      route: '/settings/home-destination',
      priority: 1,
    },
    {
      id: 'text-size',
    ...
    },
    {
      ...
      route: '/settings/lock-screen-rotation',
      priority: 2,
    },
    {
      id: 'chat-widget',
    ...
    },
    {
      ...
      sectionTitle: $localize`:@@settings.sections.navigation:Menu & Navigation`,
      icon: 'menu',
      route: '/settings/menu-customization',
      priority: 2,
      popular: true,
    },
    {
      ...
      sectionTitle: $localize`:@@settings.sections.content:Feed & Content`,
      icon: 'favorite',
      route: '/settings/default-reaction-emoji',
      priority: 3,
    },
    {
      id: 'action-buttons',
    ...
    },
    {
      ...
      sectionTitle: $localize`:@@settings.sections.content:Feed & Content`,
      icon: 'timer',
      route: '/settings/event-expiration',
      authenticated: true,
      priority: 15,
    },
    {
      ...
      sectionTitle: $localize`:@@settings.sections.general:General`,
      icon: 'calendar_month',
      route: '/settings/calendar-system',
      priority: 16,
    },
    {
      id: 'sounds',
    ...
    },
    {
      ...
      icon: 'filter_alt',
      route: '/settings/notification-spam-filter',
      authenticated: true,
      priority: 18,
    },
    {
    ...
    },
    {
      ...
      sectionTitle: $localize`:@@settings.sections.network:Relays & Network`,
      icon: 'explore',
      route: '/settings/discovery-relays',
      authenticated: true,
      priority: 2,
    },
    {
...

    {
      ...
      sectionTitle: $localize`:@@settings.sections.network:Relays & Network`,
      icon: 'visibility',
      route: '/settings/observed-relays',
      authenticated: true,
      priority: 4,
    },
    ...
    // Debug Settings
    {
      ...
      sectionTitle: $localize`:@@settings.sections.logs-debug:Logs & Debug`,
      icon: 'bug_report',
      route: '/settings/simulate-platform',
      priority: 1,
    },
  ];
