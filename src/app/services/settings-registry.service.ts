...
export class SettingsRegistryService {
  ...
  readonly sections: SettingsSection[] = [
    ...
    { id: 'backup', title: $localize`:@@settings.sections.backup:Backup`, icon: 'archive', route: '/settings/backup', authenticated: true, premium: true },
  ...
  readonly items: SettingsItem[] = [
    ...
    },
    {
      ...
      keywords: ['storage', 'database', 'size', 'cache', 'usage', 'space'],
      section: 'general',
      sectionTitle: $localize`:@@settings.sections.general:General`,
      icon: 'storage',
      route: '/settings/general',
    ...
    },
    {
      ...
      description: $localize`:@@settings.cache.emoji.description:Clear cached emoji sets from the database`,
      keywords: ['cache', 'clear', 'emoji', 'reset', 'clean'],
      section: 'general',
      sectionTitle: $localize`:@@settings.sections.general:General`,
    ...
    {
      id: 'backup-keys',
      title: $localize`:@@settings.backup.keys:Backup Keys`,
      description: $localize`:@@settings.backup.keys.description:Backup your private keys securely`,
      keywords: ['backup', 'keys', 'private', 'nsec', 'export', 'save'],
      section: 'backup',
