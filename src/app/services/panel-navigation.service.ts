...
export class PanelNavigationService {
  ...
  private routeConfig: Record<string, RouteConfig> = {
    ...
    'podcasts': { type: 'list', title: 'Podcasts' },
    'podcasts/episodes': { type: 'list', title: 'Episodes' },
    'podcasts/shows': { type: 'list', title: 'Shows' },
    'podcasts/publishers': { type: 'list', title: 'Publishers' },
    'music/offline': { type: 'list', title: 'Offline Music' },
    'music/liked': { type: 'list', title: 'Liked Songs' },
    'music/liked-playlists': { type: 'list', title: 'Liked Albums' },
    'music/tracks': { type: 'list', title: 'All Songs' },
    'music/playlists': { type: 'list', title: 'Albums' },
    ...
    'playlists': { type: 'list', title: 'Albums' },
    ...
    'podcasts/show': { type: 'detail', title: 'Podcast' },
    'podcasts/episode': { type: 'detail', title: 'Episode' },
    'podcasts/favorites': { type: 'detail', title: 'Favorite Podcasts' },
    'podcasts/publisher': { type: 'detail', title: 'Publisher' },
    ...
    'playlists/edit': { type: 'detail', title: 'Edit Album' },
