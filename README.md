...
```bash
wget -O Nostria.AppImage https://github.com/nostria-app/nostria/releases/download/v3.1.37/Nostria_3.1.37_amd64.AppImage
...
```bash
wget https://github.com/nostria-app/nostria/releases/download/v3.1.37/Nostria_3.1.37_amd64.deb
