...
```bash
wget -O Nostria.AppImage https://github.com/nostria-app/nostria/releases/download/v3.1.29/Nostria_3.1.29_amd64.AppImage
...
```bash
wget https://github.com/nostria-app/nostria/releases/download/v3.1.29/Nostria_3.1.29_amd64.deb
