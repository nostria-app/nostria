...
```bash
wget -O Nostria.AppImage https://github.com/nostria-app/nostria/releases/download/v4.1.63/Nostria_4.1.63_amd64.AppImage
...
```bash
wget https://github.com/nostria-app/nostria/releases/download/v4.1.63/Nostria_4.1.63_amd64.deb
