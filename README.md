...
```bash
wget -O Nostria.AppImage https://github.com/nostria-app/nostria/releases/download/v3.1.39/Nostria_3.1.39_amd64.AppImage
...
```bash
wget https://github.com/nostria-app/nostria/releases/download/v3.1.39/Nostria_3.1.39_amd64.deb
